...
:: ============================================
:: Based on cameraunlock-core/scripts/templates/install.cmd (BepInExPack variant).
:: Detection delegated to shared/find-game.ps1 (reads games.json).
:: PEAK uses Thunderstore's BepInExPack_PEAK: the vendor zip wraps the
:: usual BepInEx tree in a BepInExPack_PEAK/ subfolder, which we flatten
:: into the game root during install.
:: ============================================
